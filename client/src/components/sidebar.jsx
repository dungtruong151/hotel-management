      ...
      <nav>
        <List>
          ...
          <ListItemStyle disablePadding>
            ...
            >
              <ListItemIconStyle
                sx={activeItem === "/frontdesk" ? { color: "#1366D9" } : {}}
              >
                <EditNoteIcon />
              </ListItemIconStyle>
          ...
          <ListItemStyle disablePadding>
            ...
            >
              <ListItemIconStyle
                sx={activeItem === "/guest" ? { color: "#1366D9" } : {}}
              >
          ...
          <ListItemStyle disablePadding>
            ...
            >
              <ListItemIconStyle
                sx={activeItem === "/rooms" ? { color: "#1366D9" } : {}}
              >
          ...
          <ListItemStyle disablePadding>
            ...
            >
              <ListItemIconStyle
                sx={activeItem === "/deal" ? { color: "#1366D9" } : {}}
              >
          ...
          <ListItemStyle disablePadding>
            ...
            >
              <ListItemIconStyle
                sx={activeItem === "/rate" ? { color: "#1366D9" } : {}}
              >
