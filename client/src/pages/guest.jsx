...
export default function Guest() {
    ...
    const handleCheckIn = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/create', guestData);
            ...
            <div style={{margin: '30px 0 20px 0'}}>
                ...
                <Dialog open={open} onClose={handleClose}>
                    ...
                    <DialogContent>
                        ...
                        <TextField autoFocus margin="dense" id="reservation_id" label="Reservation ID" type="number" fullWidth />
